...
sim.run(until_after_sources=mp.stop_when_energy_decayed(dt=50, decay_by=1e-5))
...
def calculate_fitness(genome):
    ...
    sim_opt.run(until_after_sources=mp.stop_when_energy_decayed(dt=50, decay_by=1e-5))
